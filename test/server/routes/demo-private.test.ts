...
// spaces (their counts and cover previews), chats, and the cookie itself.
...
import { handleCollections } from '../../../server/routes/collections.ts'
import { visibleTo, visitorOf } from '../../../server/routes/demo.ts'
