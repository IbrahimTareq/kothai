...
export function ExpandedView({
  ...
  // resetScroll: a swipe to the neighbouring item swaps MainPanel's content but
  // leaves this same scrollable div in place, so without it the old scroll
  // position would carry over onto content it was never scrolled against — the
