// Tweaks.tsx — reusable Tweaks shell + form-control helpers.
//
// Owns the host protocol (listens for __activate_edit_mode / __deactivate_edit_mode,
// posts __edit_mode_available / __edit_mode_set_keys / __edit_mode_dismissed) so
// individual prototypes don't re-roll it. Trimmed to the controls Kothai actually
// uses: useTweaks, TweaksPanel, TweakSection, TweakRow, TweakRadio, TweakSelect,
...
// Relative-luminance contrast pick — checkmarks over a swatch need to read on
